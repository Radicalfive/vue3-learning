  ...
  <div class="body">
    ...
    <section class="hero-unit">
      <div class="row">
            ...
            <li ontouchstart="this.classList.toggle('hover');">
              ...
              <div class="panel card-back">
                ...
                <div class="hub-info">
                  ...
                  <p>
                    Find coding gists, cheatsheets, plugins, themes, resources,
                    and tutorials.
                  </p>
                </div>
              ...
              <div class="panel card-back">
                ...
                <div class="hub-info">
                  <a href="http://www.aaronsnowberger.com"
                    >AaronSnowberger.com</a
                  >
                  <p>
                    Take a look at my graphic design portfolio and contact me
                    for design work.
                  </p>
                </div>
            ...
            <li ontouchstart="this.classList.toggle('hover');">
              ...
              <div class="panel card-back">
                ...
                <div class="hub-info">
                  <a href="">Udemy.com</a>
                  <p>
                    Join classes about Computers, Technology, Coding, Design,
            ...
            <li ontouchstart="this.classList.toggle('hover');">
              ...
              <div class="panel card-back">
                ...
                <div class="hub-info">
                  ...
                  <p>
                    Find resources about business, family, exercise, and other
                    various topics.
                  </p>
                </div>
            ...
            <li ontouchstart="this.classList.toggle('hover');">
              ...
              <div class="panel card-back">
                ...
                <div class="hub-info">
                  ...
                  <p>
                    Take your Korean from "foreign" to fluent with vocab lists
                    and grammar guides.
                  </p>
                </div>
            ...
            <li ontouchstart="this.classList.toggle('hover');">
              ...
              <div class="panel card-back">
                ...
                <div class="hub-info">
                  ...
                  <p>
                    Listen to sermon podcasts or download church graphic design
                    resources.
                  </p>
                </div>
        ...
        <div class="large-12 columns">
          <div
            class="small-12 small-centered medium-6 medium-centered large-3 large-centered columns clients"
          >
            <a href="#">
